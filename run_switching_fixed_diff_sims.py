...
from bandits import ots_selection, bucb_selection, efe_selection, app_selection, sai_selection
...
if __name__=="__main__":
    ...
    parser.add_argument("--algos", nargs='+', default=['O-TS', 'B-UCB', 'G-AI', 'A-AI', 'S-AI'], type=str)
